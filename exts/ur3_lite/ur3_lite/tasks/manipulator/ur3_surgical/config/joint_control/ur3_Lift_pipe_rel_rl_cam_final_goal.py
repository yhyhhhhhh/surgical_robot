...
class Ur3LiftNeedleEnv(DirectRLEnv):
    ...
    def __init__(self, cfg: Ur3LiftPipeEnvCfg, render_mode: str | None = None, **kwargs):
        ...
        self.goal_pos_local = torch.tensor([0.00, -0.29, -0.21], device=self.device)  # 例子，自己按场景改
    ...
    def _reset_idx(self, env_ids: torch.Tensor | None):
        ...
        self.prev_obj_goal_dist[env_ids] = torch.norm(obj_pos_w - self.goal_pos_w[env_ids], dim=1)
    ...
    def _get_observations(self) -> dict:
        ...
        obs = torch.cat(
            (
                ...
                cos_dyaw.unsqueeze(-1), sin_dyaw.unsqueeze(-1),
