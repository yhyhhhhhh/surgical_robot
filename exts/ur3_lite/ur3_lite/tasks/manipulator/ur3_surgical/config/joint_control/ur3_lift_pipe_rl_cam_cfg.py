...
class Ur3LiftPipeEnvCfg(DirectRLEnvCfg):
    ...
    #     spawn=sim_utils.UsdFileCfg(
    #         usd_path="/home/yhy/DVRK/IsaacLabExtensionTemplate/exts/ur3_lite/ur3_lite/tasks/manipulator/ur3_surgical/assets/OR_scene_s0253_ct_relabel_resample1_syn_seed6_postprocess/operating_room.usd",
