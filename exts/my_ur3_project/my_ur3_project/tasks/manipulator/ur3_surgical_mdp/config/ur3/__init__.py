...
from . import (
    ...
    takeoff_ik_rel_env_cfg,
    takeoff_joint_pos_env_cfg,
    hard_takeoff_ik_rel_env_cfg
)
...
gym.register(
    id="Isaac-Takeoff-Franka-v0",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": takeoff_joint_pos_env_cfg.FrankaTakeoffEnvCfg,
    },
    disable_env_checker=True,
)
...
gym.register(
    id="Isaac-Takeoff-Franka-IK-Rel-v0",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": takeoff_ik_rel_env_cfg.FrankaTakeoffEnvCfg,
        "robomimic_bc_cfg_entry_point": os.path.join(agents.__path__[0], "robomimic/bc_rnn_low_dim.json"),
    },
    disable_env_checker=True,
)
...
gym.register(
    id="Isaac-Takeoff-Hard-Franka-IK-Rel-v0",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": hard_takeoff_ik_rel_env_cfg.Hard_FrankaTakeoffEnvCfg,
        "robomimic_bc_cfg_entry_point": os.path.join(agents.__path__[0], "robomimic/bc_rnn_low_dim.json"),
    },
    disable_env_checker=True,
)