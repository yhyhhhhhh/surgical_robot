...
class RSSM(nn.Module):
    ...
    def observe(self, embed, action, is_first, state=None):
        ...
        # 每一步根据“上一时刻的 latent + 当前动作 a_t + 当前观测 embedding x_t”，
    ...
    def obs_step(self, prev_state, prev_action, embed, is_first, sample=True): # sample=False):
        # initialize all prev_state 初始化所有的prev_state，如果是序列开始prev_state为0，否则保留原来的值
    ...
    def img_step(self, prev_state, prev_action, sample=True): # sample=False):
