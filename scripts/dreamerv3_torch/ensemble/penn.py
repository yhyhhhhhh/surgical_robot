...
class EnsembleStochasticLinear(torch.nn.Module):
    def __init__(self, in_features, out_features, hidden_features, ensemble_size=3, activation='relu', explore_var='jrd', residual=True, norm=True, dt=0.1):
        ...
        self.lin3 = EnsembleLinear(in_features=hidden_features * 2,
                                   out_features=hidden_features * 3, ensemble_size=self.ensemble_size, bias=True, norm=norm)
