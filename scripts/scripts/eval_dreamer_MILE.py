...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default="/home/yhy/IsaacLabExtensionTemplate/latent_safety/log/dreamerv3/world_model_only/0310/220112_test/latest.pt")
