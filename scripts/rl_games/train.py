...
parser.add_argument("--task", type=str, default="Isaac-Reach-PSM-v0", help="Name of the task.")
# parser.add_argument("--task", type=str, default="Template-Isaac-Ur3-Reach-Direct-v0", help="Name of the task.")
